...
{
	texture_load_from_file(sdl, sdl->textures[0], "dots.png");
	sdl->sprite_clips[0].x = 0;
	sdl->sprite_clips[0].y = 0;
	sdl->sprite_clips[0].w = 100;
	sdl->sprite_clips[0].h = 100;

	sdl->sprite_clips[1].x = 100;
	sdl->sprite_clips[1].y = 0;
	sdl->sprite_clips[1].w = 100;
	sdl->sprite_clips[1].h = 100;

	sdl->sprite_clips[2].x = 0;
	sdl->sprite_clips[2].y = 100;
	sdl->sprite_clips[2].w = 100;
	sdl->sprite_clips[2].h = 100;

	sdl->sprite_clips[3].x = 100;
	sdl->sprite_clips[3].y = 100;
	sdl->sprite_clips[3].w = 100;
	sdl->sprite_clips[3].h = 100;
}
...
int	main(int argc, char **argv)
{
	...
	while (1)
	{
		...
		render_texture(sdl, sdl->textures[0], 0, 0, &sdl->sprite_clips[0]);
		render_texture(sdl, sdl->textures[0], SCREEN_WIDTH - sdl->sprite_clips[1].w, 0, &sdl->sprite_clips[1]);
		render_texture(sdl, sdl->textures[0], 0, SCREEN_HEIGHT - sdl->sprite_clips[2].h, &sdl->sprite_clips[2]);
		render_texture(sdl, sdl->textures[0], SCREEN_WIDTH - sdl->sprite_clips[3].w, SCREEN_HEIGHT - sdl->sprite_clips[3].h, &sdl->sprite_clips[3]);
